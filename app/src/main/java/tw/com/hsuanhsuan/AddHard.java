...
public class AddHard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        while (QNBoolean01<2){
            ...
            Total = N1+N2;
            if(N1>N2&&N1>100&&N2>100&&Total<1000){
                    ...
                    if(Answer.equals(Sum)){
                        ...
                        if(QNum==40){
                            if(Score==200){
                                ...
                                it.setClass(AddHard.this,Star5.class);
                                startActivity(it);
                            }else if(Score>150){
                                Intent it = new Intent();
                                it.setClass(AddHard.this,Star4.class);
                                startActivity(it);
                            }else if(Score>100){
                                Intent it = new Intent();
                                it.setClass(AddHard.this,Star3.class);
                                startActivity(it);
                            }else if(Score>50){
                                Intent it = new Intent();
                                it.setClass(AddHard.this,Star2.class);
                                startActivity(it);
                            }else{
                                Intent it = new Intent();
                                it.setClass(AddHard.this,Star1.class);
                                startActivity(it);
                            }
                        }
                        QNum = QNum+1;
        ...
        backto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                ...
                intent.setClass(AddHard.this, Addgame.class);
        ...
        again.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                ...
                Intent intent = new Intent();
                intent.setClass(AddHard.this, AddHard.class);
                startActivity(intent);
            }
        });
    }
