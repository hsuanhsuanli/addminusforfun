...
public class MinusEasy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                    ...
                    if(Answer.equals(Sum)){
                        ...
                        if(QNum==40){
                            if(Score==200){
                                ...
                                it.setClass(MinusEasy.this,Star5.class);
                                startActivity(it);
                            }else if(Score>150){
                                Intent it = new Intent();
                                it.setClass(MinusEasy.this,Star4.class);
                                startActivity(it);
                            }else if(Score>100){
                                Intent it = new Intent();
                                it.setClass(MinusEasy.this,Star3.class);
                                startActivity(it);
                            }else if(Score>50){
                                Intent it = new Intent();
                                it.setClass(MinusEasy.this,Star2.class);
                                startActivity(it);
                            }else{
                                Intent it = new Intent();
                                it.setClass(MinusEasy.this,Star1.class);
                                startActivity(it);
                            }
                        }
                        QNum = QNum+1;
        ...
        backto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                ...
                intent.setClass(MinusEasy.this, Minusgame.class);
        ...
        again.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                ...
                Intent intent = new Intent();
                intent.setClass(MinusEasy.this, MinusEasy.class);
                startActivity(intent);
            }
        });
    }
